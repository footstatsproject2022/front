<div id="team-player-details">
    <div class="row">
        <!-- Begin::Player Basic details -->
        <div class="col-sm-6 player-basic-details-area">
        ...
        <!-- End::Player Basic details -->

        
        <!-- Begin::Market Value -->
        <div class="col-sm-6 player-market-value-area">
            <div class="d-flex justify-content-between">
                <h4>Market Value <small>Current $2.8Bn</small></h4>
